    ...
    if (null != t) {
        ...
        <div class="forecast-icon">
                  <img src="https:${t.condition.icon}" alt="" width=90>
                      ...
                      <span><img src="images/icon-umberella.png" alt="">${t.vis_km} %</span>
                  <span><img src="images/icon-wind.png" alt="">${t.wind_kph} km/h</span>
                  <span><img src="images/icon-compass.png" alt="">${t.wind_dir}</span>
                      </div>
                  </div>`;
